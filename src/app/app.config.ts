...
export const appConfig: ApplicationConfig = {
  providers: [
    ...
    provideFirebaseApp(() => initializeApp({ projectId: "citypenha", appId: "1:771190117440:web:df15e21d9dd4914bf2fba5", storageBucket: "citypenha.firebasestorage.app", apiKey: "AIzaSyD0LfWjCrt5v1dDGGQMS8Qpe8tcUQPfMTs", authDomain: "citypenha.firebaseapp.com", messagingSenderId: "771190117440", projectNumber: "771190117440", version: "2" } as any)),
    provideAuth(() => getAuth())
  ]
};
